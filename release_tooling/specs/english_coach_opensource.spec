...
# PyInstaller spec for english-coach OPEN SOURCE version
# Build: python build_opensource.py
...
_WEBVIEW = _PACKAGE_DIRS['webview']
...
a = Analysis(
    ...
    datas=[
        ...
        # Bundle the full content tree so packaged builds are usable out of the box.
