; Inno Setup Script for English Coach - Open Source Edition
; This creates a professional Windows installer

#define MyAppName "English Coach (Open Source)"
#define MyAppVersion "2.0.0"
#define MyAppPublisher "English Coach"
#define MyAppURL "https://github.com/tryandaction/english-coach"
#define MyAppExeName "english-coach-opensource.exe"
#define MyAppUninstallKey "{A1B2C3D4-E5F6-7890-ABCD-EF1234567890}_is1"
#define ProjectRoot "..\.."
...
DefaultDirName={localappdata}\English Coach Open Source
DefaultGroupName=English Coach Open Source
...
OutputBaseFilename=english-coach-opensource-setup
...
begin
  ...
  WelcomeLabel.Caption :=
    'This is the Open Source edition of English Coach.' + #13#10 + #13#10 +
    'You will need to configure your own API key (DeepSeek/OpenAI/Claude/Qwen) to use this application.' + #13#10 + #13#10 +
    'Bundled starter content and built-in vocabulary libraries are included.' + #13#10 + #13#10 +
